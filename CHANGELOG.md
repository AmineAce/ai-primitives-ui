...
- **Playground & docs catch up:** `/` showcase and `/#playground` now show all 24 orbs with `orbSizes xs 16 → 2xl 96` + `speed/paused` knobs. `ProgressOrb` demo lets you drag `value`.
